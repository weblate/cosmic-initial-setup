...
appearance-page = Personalisasikan tampilan
    ...
    .effects = Efek
    .frosted-glass = Kaca es
    .frosted-description = Menerapkan ke panel, applet, jendela dan antarmuka sistem
    .effects-tip = Anda dapat menyesuaikan warna aksen dan tampilan desktop Anda lebih lanjut di pengaturan Tampilan.
    .tip = Petunjuk:
