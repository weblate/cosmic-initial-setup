...
appearance-page = Aussehen personalisieren
    ...
    .effects = Effekte
    .frosted-glass = Milchglass
    .frosted-description = Gilt für Panels, Applets, Fenster und Systemschnittstellen
    .effects-tip = Du kannst die Akzentfarben und das Erscheinungsbild deines Desktops in den Einstellungen für das Aussehen weiter anpassen.
    .tip = Tipp:
layout-page = Konfiguration der Anordnung
    .bottom-panel = Panel unten
    .top-panel-and-dock = Panel oben und Dock
    .description = Nutze die Einstellungen, um das Panel oder Dock an eine beliebige Seite zu verschieben, deren Größen zu ändern oder sie automatisch auszublenden.
